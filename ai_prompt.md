Below is a **ready-to-use, copy-paste prompt** you can give directly to **Kiro**.
It is structured, explicit, and written as a software architecture + implementation request so Kiro can generate a complete solution.
